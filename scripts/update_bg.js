...
files.forEach(file => {
  ...
  // Replace remaining exact hex codes for backgrounds (excluding the VIP card '#151515')
  ...
  // We don't want to blindly replace all #fff because of icons, borders, but we need text to be readable.
  // Actually, we'll just fix the obvious sections where we know text is now white on #ede5dd
